...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 5
        testRunner.Given("que acesso a pagina incial do site PO", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Dado ");
#line hidden
#line 6
        testRunner.When(string.Format("preencho o usuario como {0} PO", usuario), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Quando ");
#line hidden
#line 7
